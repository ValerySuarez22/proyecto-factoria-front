...
class CalendarPageResponsible extends React.Component {
  ...
  handleAddEvent = (event) => {
    ...
    axios
      .post(
        "http://127.0.0.1:8000/api/calendar/new",
        formatEvent
        //   {
        //   headers: {
  ...
  handleCancel = () => {
    ...
    console.log("adiós", selectedEvent);
  ...
  handleDeleteEvent = (id) => {
    ...
    axios
      .delete(`http://127.0.0.1:8000/api/calendar/${id}/delete`)
      .then(() => {
      ...
      <div className="calendar-container wrapper">
        ...
        <div style={{ height: "500px", width: "90%", margin: "0 auto" }}>
          <Calendar
            ...
            components={{
              event: (props) => (
                <Event {...props} selected={props.event === selectedEvent} />
              ),
            }}
            messages={{
              today: "Hoy",
          ...
          {selectedEvent && (
            <div className={`event-description ${selectedEvent && "selected"}`}>
              ...
              <button
                ...
                onClick={() => this.handleDeleteEvent(selectedEvent.id)}
              >
                Eliminar
              </button>
